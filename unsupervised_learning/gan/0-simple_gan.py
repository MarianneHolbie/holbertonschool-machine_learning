...
class Simple_GAN(keras.Model):
    ...
    def __init__(self, generator, discriminator, latent_generator, real_examples, batch_size=200, disc_iter=2,
        ...
        :param disc_iter: number of iter for discriminator in one iter of training
    ...
    def get_fake_sample(self, size=None, training=False):
        ...
        :param training: False to obtain sample generated by model in eval mode
    ...
    def train_step(self, useless_argument):
        ...
        :param useless_argument: normaly pass data, but here data=self.real_example
        ...
        for _ in range(self.disc_iter):
            ...
            with tf.GradientTape() as disc_tape:
                ...
                discr_loss = self.discriminator.loss(x=disc_real_output, y=disc_fake_output)
